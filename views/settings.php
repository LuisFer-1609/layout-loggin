<!DOCTYPE html>
<!-- saved from url=(0044)https://social.webestica.com/settings.html#! -->
          ...
          <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar">
            ...
            <div class="offcanvas-body p-0">
              ...
              <div class="card w-100">
                ...
                <ul class="nav nav-tabs nav-pills nav-pills-soft flex-column fw-bold gap-2 border-0" role="tablist">
                  <li class="nav-item" data-bs-dismiss="offcanvas" role="presentation">
                    <a class="nav-link d-flex mb-0 active" href="https://social.webestica.com/settings.html#nav-setting-tab-1" data-bs-toggle="tab" aria-selected="true" role="tab"> <img class="me-2 h-20px fa-fw" src="./settings_files/person-outline-filled.svg" alt=""><span>Account </span></a>
                  </li>
                  <li class="nav-item" data-bs-dismiss="offcanvas" role="presentation">
                    <a class="nav-link d-flex mb-0" href="https://social.webestica.com/settings.html#nav-setting-tab-2" data-bs-toggle="tab" aria-selected="false" tabindex="-1" role="tab"> <img class="me-2 h-20px fa-fw" src="./settings_files/notification-outlined-filled.svg" alt=""><span>Notification </span></a>
                  </li>
                  <li class="nav-item" data-bs-dismiss="offcanvas" role="presentation">
                    <a class="nav-link d-flex mb-0" href="https://social.webestica.com/settings.html#nav-setting-tab-3" data-bs-toggle="tab" aria-selected="false" tabindex="-1" role="tab"> <img class="me-2 h-20px fa-fw" src="./settings_files/shield-outline-filled.svg" alt=""><span>Privacy and safety </span></a>
                  </li>
                  <li class="nav-item" data-bs-dismiss="offcanvas" role="presentation">
                    <a class="nav-link d-flex mb-0" href="https://social.webestica.com/settings.html#nav-setting-tab-4" data-bs-toggle="tab" aria-selected="false" tabindex="-1" role="tab"> <img class="me-2 h-20px fa-fw" src="./settings_files/handshake-outline-filled.svg" alt=""><span>Communications </span></a>
                  </li>
                  <li class="nav-item" data-bs-dismiss="offcanvas" role="presentation">
                    <a class="nav-link d-flex mb-0" href="https://social.webestica.com/settings.html#nav-setting-tab-5" data-bs-toggle="tab" aria-selected="false" tabindex="-1" role="tab"> <img class="me-2 h-20px fa-fw" src="./settings_files/chat-alt-outline-filled.svg" alt=""><span>Messaging </span></a>
                  </li>
                  <li class="nav-item" data-bs-dismiss="offcanvas" role="presentation">
                    <a class="nav-link d-flex mb-0" href="https://social.webestica.com/settings.html#nav-setting-tab-6" data-bs-toggle="tab" aria-selected="false" tabindex="-1" role="tab"> <img class="me-2 h-20px fa-fw" src="./settings_files/trash-var-outline-filled.svg" alt=""><span>Close account </span></a>
                  </li>
                </ul>
                <!-- Side Nav END -->
              ...
              <div class="card-footer text-center py-2">
                <a class="btn btn-link text-secondary btn-sm" href="https://social.webestica.com/settings.html#!">View Profile </a>
              </div>
              </div>
            <!-- Card END -->
            </div>
            ...
            <ul class="nav small mt-4 justify-content-center lh-1">
              <li class="nav-item">
                <a class="nav-link" href="https://social.webestica.com/my-profile-about.html">About</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="https://social.webestica.com/settings.html">Settings</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" target="_blank" href="https://support.webestica.com/login">Support </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" target="_blank" href="https://social.webestica.com/docs/index.html">Docs </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="https://social.webestica.com/help.html">Help</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="https://social.webestica.com/privacy-and-terms.html">Privacy &amp; terms</a>
              </li>
            </ul>
            <!-- Helper link END -->
            <!-- Copyright -->
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3">
                    ...
                    <div class="col-sm-6">
                      ...
                      <!-- Add new number -->
                      <a class="btn btn-sm btn-dashed rounded mt-2" href="https://social.webestica.com/settings.html#!"> <i class="bi bi-plus-circle-dotted me-1"></i>Add new phone number</a>
                    </div>
                    <!-- Phone number -->
                    <div class="col-sm-6">
                      ...
                      <!-- Add new email -->
                      <a class="btn btn-sm btn-dashed rounded mt-2" href="https://social.webestica.com/settings.html#!"> <i class="bi bi-plus-circle-dotted me-1"></i>Add new email address</a>
                    </div>
                    <!-- Page information -->
                    <div class="col-12">
                      ...
                      <div class="accordion accordion-flush border-0" id="emailNotifications">
                        ...
                        <div class="accordion-item bg-transparent">
                          <h2 class="accordion-header" id="flush-headingOne">
                            <a href="https://social.webestica.com/settings.html#!" class="accordion-button mb-0 p-0 collapsed bg-transparent shadow-none" data-bs-toggle="collapse" data-bs-target="#flush-collapseOne" aria-expanded="false" aria-controls="flush-collapseOne">
                              <span>
            ...
            <div class="tab-pane fade" id="nav-setting-tab-6" role="tabpanel">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <h6>Before you go...</h6>
                  <ul>
                    <li>Take a backup of your data <a href="https://social.webestica.com/settings.html#">Here</a> </li>
                  ...
                  <a href="https://social.webestica.com/settings.html#" class="btn btn-success-soft btn-sm mb-2 mb-sm-0">Keep my account</a>
                  <a href="https://social.webestica.com/settings.html#" class="btn btn-danger btn-sm mb-0">Delete my account</a>
                  <!-- Delete END -->
                </div>
              <!-- Card body END -->
              </div>
...
<script src="../sources/dropzone.js"></script>
<script src="../sources/flatpickr.min.js"></script>
<script src="../sources/pswmeter.min.js"></script>

<!-- Theme Functions -->
<script src="../sources/functions.js"></script><div class="flatpickr-calendar animate" tabindex="-1"><div class="flatpickr-months"><span class="flatpickr-prev-month"><svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 17 17"><g></g><path d="M5.207 8.471l7.146 7.147-0.707 0.707-7.853-7.854 7.854-7.853 0.707 0.707-7.147 7.146z"></path></svg></span><div class="flatpickr-month"><div class="flatpickr-current-month"><select class="flatpickr-monthDropdown-months" aria-label="Month" tabindex="-1"><option class="flatpickr-monthDropdown-month" value="0" tabindex="-1">January</option><option class="flatpickr-monthDropdown-month" value="1" tabindex="-1">February</option><option class="flatpickr-monthDropdown-month" value="2" tabindex="-1">March</option><option class="flatpickr-monthDropdown-month" value="3" tabindex="-1">April</option><option class="flatpickr-monthDropdown-month" value="4" tabindex="-1">May</option><option class="flatpickr-monthDropdown-month" value="5" tabindex="-1">June</option><option class="flatpickr-monthDropdown-month" value="6" tabindex="-1">July</option><option class="flatpickr-monthDropdown-month" value="7" tabindex="-1">August</option><option class="flatpickr-monthDropdown-month" value="8" tabindex="-1">September</option><option class="flatpickr-monthDropdown-month" value="9" tabindex="-1">October</option><option class="flatpickr-monthDropdown-month" value="10" tabindex="-1">November</option><option class="flatpickr-monthDropdown-month" value="11" tabindex="-1">December</option></select><div class="numInputWrapper"><input class="numInput cur-year" type="number" tabindex="-1" aria-label="Year"><span class="arrowUp"></span><span class="arrowDown"></span></div></div></div><span class="flatpickr-next-month"><svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 17 17"><g></g><path d="M13.207 8.472l-7.854 7.854-0.707-0.707 7.146-7.146-7.146-7.148 0.707-0.707 7.854 7.854z"></path></svg></span></div><div class="flatpickr-innerContainer"><div class="flatpickr-rContainer"><div class="flatpickr-weekdays"><div class="flatpickr-weekdaycontainer">
      <span class="flatpickr-weekday">
        Sun</span><span class="flatpickr-weekday">Mon</span><span class="flatpickr-weekday">Tue</span><span class="flatpickr-weekday">Wed</span><span class="flatpickr-weekday">Thu</span><span class="flatpickr-weekday">Fri</span><span class="flatpickr-weekday">Sat
      </span>
      </div></div><div class="flatpickr-days" tabindex="-1"><div class="dayContainer"><span class="flatpickr-day prevMonthDay" aria-label="December 31, 1989" tabindex="-1">31</span><span class="flatpickr-day selected" aria-label="January 1, 1990" tabindex="-1">1</span><span class="flatpickr-day " aria-label="January 2, 1990" tabindex="-1">2</span><span class="flatpickr-day " aria-label="January 3, 1990" tabindex="-1">3</span><span class="flatpickr-day " aria-label="January 4, 1990" tabindex="-1">4</span><span class="flatpickr-day " aria-label="January 5, 1990" tabindex="-1">5</span><span class="flatpickr-day " aria-label="January 6, 1990" tabindex="-1">6</span><span class="flatpickr-day " aria-label="January 7, 1990" tabindex="-1">7</span><span class="flatpickr-day " aria-label="January 8, 1990" tabindex="-1">8</span><span class="flatpickr-day " aria-label="January 9, 1990" tabindex="-1">9</span><span class="flatpickr-day " aria-label="January 10, 1990" tabindex="-1">10</span><span class="flatpickr-day " aria-label="January 11, 1990" tabindex="-1">11</span><span class="flatpickr-day " aria-label="January 12, 1990" tabindex="-1">12</span><span class="flatpickr-day " aria-label="January 13, 1990" tabindex="-1">13</span><span class="flatpickr-day " aria-label="January 14, 1990" tabindex="-1">14</span><span class="flatpickr-day " aria-label="January 15, 1990" tabindex="-1">15</span><span class="flatpickr-day " aria-label="January 16, 1990" tabindex="-1">16</span><span class="flatpickr-day " aria-label="January 17, 1990" tabindex="-1">17</span><span class="flatpickr-day " aria-label="January 18, 1990" tabindex="-1">18</span><span class="flatpickr-day " aria-label="January 19, 1990" tabindex="-1">19</span><span class="flatpickr-day " aria-label="January 20, 1990" tabindex="-1">20</span><span class="flatpickr-day " aria-label="January 21, 1990" tabindex="-1">21</span><span class="flatpickr-day " aria-label="January 22, 1990" tabindex="-1">22</span><span class="flatpickr-day " aria-label="January 23, 1990" tabindex="-1">23</span><span class="flatpickr-day " aria-label="January 24, 1990" tabindex="-1">24</span><span class="flatpickr-day " aria-label="January 25, 1990" tabindex="-1">25</span><span class="flatpickr-day " aria-label="January 26, 1990" tabindex="-1">26</span><span class="flatpickr-day " aria-label="January 27, 1990" tabindex="-1">27</span><span class="flatpickr-day " aria-label="January 28, 1990" tabindex="-1">28</span><span class="flatpickr-day " aria-label="January 29, 1990" tabindex="-1">29</span><span class="flatpickr-day " aria-label="January 30, 1990" tabindex="-1">30</span><span class="flatpickr-day " aria-label="January 31, 1990" tabindex="-1">31</span><span class="flatpickr-day nextMonthDay" aria-label="February 1, 1990" tabindex="-1">1</span><span class="flatpickr-day nextMonthDay" aria-label="February 2, 1990" tabindex="-1">2</span><span class="flatpickr-day nextMonthDay" aria-label="February 3, 1990" tabindex="-1">3</span><span class="flatpickr-day nextMonthDay" aria-label="February 4, 1990" tabindex="-1">4</span><span class="flatpickr-day nextMonthDay" aria-label="February 5, 1990" tabindex="-1">5</span><span class="flatpickr-day nextMonthDay" aria-label="February 6, 1990" tabindex="-1">6</span><span class="flatpickr-day nextMonthDay" aria-label="February 7, 1990" tabindex="-1">7</span><span class="flatpickr-day nextMonthDay" aria-label="February 8, 1990" tabindex="-1">8</span><span class="flatpickr-day nextMonthDay" aria-label="February 9, 1990" tabindex="-1">9</span><span class="flatpickr-day nextMonthDay" aria-label="February 10, 1990" tabindex="-1">10</span></div></div></div></div></div>
