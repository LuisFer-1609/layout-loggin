<!DOCTYPE html>
<!-- saved from url=(0043)https://social.webestica.com/error-404.html -->
  ...
  <div class="container">
    ...
    <div class="row align-items-center text-center py-sm-5">
      ...
      <div class="col-lg-8 mx-auto">
        ...
        <!-- Button -->
        <a class="btn btn-primary-soft btn-sm" href="https://social.webestica.com/index.html">Got to home page</a>
      </div>
      <!-- Error 404 START -->
    </div> 
    <!-- Extra space -->
...
<!-- Bootstrap JS -->
<script src="../sourves/bootstrap.bundle.min.js"></script>
